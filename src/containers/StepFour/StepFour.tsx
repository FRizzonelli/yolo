      ...
      <div className='bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6 h-96 flex flex-col justify-evenly'>
        ...
        <div className='mt-5 md:mt-0 md:col-span-2 flex justify-evenly'>
          <button
            ...
            className='mr-3 w-60 inline-flex justify-center py-2 px-4 border border-solid border-indigo-600 bg-white hover:bg-gray-50 shadow-sm text-sm font-medium rounded-md text-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500'
          >
            Car
          </button>
